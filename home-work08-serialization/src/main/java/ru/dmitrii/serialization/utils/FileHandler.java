package ru.dmitrii.serialization.utils;
...
public abstract class FileHandler {
     ...
     * @return Map<List < ?>, List<?>>
     */
    private static Map<List<?>, List<?>> getZipObject(File file, Map<List<?>, List<?>> map) {
     ...
     * @param file File
     */
    private static void writeFileObject(Map<List<?>, List<?>> map, File file) {
     ...
     * @param file File
     */
    private static void writeZipObject(Map<List<?>, List<?>> map, File file) {
     ...
     * @param zip  boolean
     */
    public static void writeList(Map<List<?>, List<?>> map, File file, boolean zip) {
        if (!zip) {
     ...
     * @param file File
     */
    private static void writeZipList(Map<List<?>, List<?>> map, File file) {
        try (GZIPOutputStream outputStream = new GZIPOutputStream(new FileOutputStream(file));
             ObjectOutputStream out = new ObjectOutputStream(outputStream)) {
            out.writeObject(map);
            out.flush();
